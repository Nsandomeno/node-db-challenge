...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
  ...
  Relational databases are databases whose tables have fields that relate to each other. SQL is a language designed to program a database management system for a database.

- [ ] Why do tables need a `primary key`?

  Tables need primary keys as unique identifiers for all of their entries.
...
We need an intermediary table that holds a composite primary key that is made up of two foreign keys pointing to the ids for each of the other/associated tables.
